    ...
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            res = _context2.sent;
            //force reload from server not from browser cache. If not the browser might
            //reload from cache which may have our user menue up there
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoibWRyYWoyIiwiYSI6ImNrM3MxY3M1YzAwaHEzbnF2dmFqN2loNnAifQ.R8V-k-7eKGS_p8lgUqUF9A';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/mdraj2/ck3t97nql05b21cnivq2biu9o',
    scrollZoom: false
  });
...
if (loginForm) {
  loginForm.addEventListener('submit', function (e) {
    ...
    var password = document.getElementById('password').value; // this prevent loading of any page

    e.preventDefault(); //get the values in the email and the passwoed

    (0, _login.login)(email, password);
  });
}

if (logOutBtn) logOutBtn.addEventListener('click', _login.logout); //Change user name or email
